...
<div class="src"><span>対象：<b>{esc(title)}</b></span><span>配信長 <b>{esc(M['dur'])}</b></span><span class="mono">source: youtube live chat replay</span></div></header>
<div class="kpis">
...
<section><div class="h2"><span class="n">05</span><h2>コアファン構造</h2></div>
<p class="sub">{fan_sub}</p><div class="card"><div class="fans">{fans_html}</div></div></section>
